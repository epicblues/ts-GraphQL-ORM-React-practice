...
export type PostSnippetFragment = { __typename?: 'Post', id: number, title: string, textSnippet: string, creatorId: number, createdAt: string, updatedAt: string, points: number, voteStatus?: number | null | undefined, creator: { __typename?: 'User', username: string, id: number } };
...
export type CreatePostMutation = { __typename?: 'Mutation', createPost: { __typename?: 'PostResponse', errors?: Array<{ __typename?: 'FieldError', field: string, message: string }> | null | undefined, post?: { __typename?: 'Post', title: string, text: string } | null | undefined } };
...
export type PostsQuery = { __typename?: 'Query', posts: { __typename?: 'PaginatedPosts', hasMore: boolean, posts: Array<{ __typename?: 'Post', id: number, title: string, textSnippet: string, creatorId: number, createdAt: string, updatedAt: string, points: number, voteStatus?: number | null | undefined, creator: { __typename?: 'User', username: string, id: number } }> } };
